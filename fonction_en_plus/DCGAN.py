...
# this is python using object-oriented programming,
# we define a class that inherits from keras.Model

# In pytorch it is better to work in lightning,
# better separation of concerns, more modular, easier to read
# and maintain. The work is similar to keras.Model,
# but we have to implement more methods
...
class DCGAN(keras.Model):
    ...
    def train_step(self, inputs): 
        ...
        # we check the size of the batch, because it can be smaller
        #  than the one specified in .fit() for the last batch
